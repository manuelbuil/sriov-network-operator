if [ -z $SKIP_VAR_SET ]; then
        ...
        export SRIOV_INFINIBAND_ENABLE=${SRIOV_INFINIBAND_ENABLE:-false}
        ...
        [ -z $SRIOV_INFINIBAND_ENABLE ] && echo "SRIOV_INFINIBAND_ENABLE is empty but SKIP_VAR_SET is set" && exit 1
